/**
 * @param props.surface_installation - Surface de l'installation de refroidissement (m²)
 * @param props.surface_installations - Surface totale des installations de refroidissement (m²)
